document.addEventListener('DOMContentLoaded', function() {
  const agregarUsuarioForm = document.getElementById('formAgregarUsuario');
  const editarUsuarioForm = document.getElementById('editarUsuarioForm');
  const agregarUsuarioBtn = document.getElementById('btnAgregarUsuario');
  ...
  forms.forEach((form, index) => {
      if (form) {
          form.addEventListener('submit', function(event) {
              if (!form.checkValidity()) {
                  ...
                  if (buttons[index]) {
                      ...
                      buttons[index].classList.add('btn-disabled'); // Añade una clase para cambiar la apariencia
          ...
          const fechaContratacionWrapper = form.querySelector('#fechaContratacionWrapper');
          ...
          if (rolSelect) {
              ...
              function handleRoleChange() {
                  ...
                  if (rolSelect.value === 'empleado' || rolSelect.value === 'admin') {
                      ...
                      if (fechaContratacionWrapper) fechaContratacionWrapper.style.display = 'block';
                      ...
                      if (fechaContratacionWrapper) fechaContratacionWrapper.style.display = 'none';
