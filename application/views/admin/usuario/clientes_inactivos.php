<main id="main" class="main">
  <div class="pagetitle">
    <h1 style="color: #28a745;">Clientes Inactivos</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url('admin'); ?>">Inicio</a></li>
        <li class="breadcrumb-item"><a href="<?= base_url('usuarios/clientes'); ?>">Gestión de Clientes</a></li>
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title" style="color: var(--default-color);">Clientes Inactivos</h5>

            <a href="<?= base_url('usuarios/clientes'); ?>" class="btn btn-secondary">
              <i class="bi bi-arrow-left-circle"></i> Volver a Clientes Activos
            </a>
            ...
            <table class="table">
              ...
              <tbody>
                  ...
                  <?php foreach($clientes as $cliente): ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?php echo base_url('usuarios/editar/'.$cliente->id); ?>" class="btn btn-warning">
                          <i class="bi bi-pencil-square"></i>
                        </a>
                        <a href="#" class="btn btn-danger delete-user" data-id="<?php echo $cliente->id; ?>" data-name="<?php echo $cliente->nombre . ' ' . $cliente->apellido . ' ' . $cliente->segundo_apellido; ?>">
                ...
                <?php else : ?>
                  <tr>
                    <td colspan="9" class="text-center">No hay clientes inactivos registrados.</td>
                  </tr>
                <?php endif; ?>
              </tbody>
            </table>
