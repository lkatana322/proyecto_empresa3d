...
<section id="categoria-producto" class="categoria-producto section">

    <div class="container section-title text-center" data-aos="fade-up">
        <h2 class="category-title"><?php echo isset($categoria->nombre) ? $categoria->nombre : 'Categoría'; ?></h2>
        <div class="title-divider"></div>
        <p class="category-subtitle"><?php echo isset($categoria->descripcion) ? $categoria->descripcion : 'Descripción de la categoría'; ?></p>
    </div>
